...
if [ "" == "${K8S_MASTER_IP}" ]; then
   echo -e "\033[33mWARNING: K8S_MASTER_IP is blank,use default value: 192.168.1.51\033[0m"
   K8S_MASTER_IP="192.168.1.51"
fi

if [ "" == "${ETCD_ENDPOINTS}" ]; then
    echo -e "\033[33mWARNING: ETCD_ENDPOINTS is blank,use default value: https://192.168.1.51:2379,https://192.168.1.52:2379,https://192.168.1.53:2379\033[0m"
...
wget https://github.com/projectcalico/calicoctl/releases/download/v3.2.6/calicoctl-linux-amd64 -O /usr/bin/calicoctl
